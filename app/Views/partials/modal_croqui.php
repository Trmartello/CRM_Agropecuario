    ...
    <div class="modal-content">
      ...
      <div class="modal-body d-flex flex-column p-2 gap-2">
        ...
        <div class="small text-muted">
          ...
          use +/− ou a roda do mouse para o zoom, arraste um ponto para ajustar, <strong>toque sobre a linha para inserir um ponto</strong> e refinar, ou <strong>toque em um ponto e no ✕ para removê-lo</strong>). A divisa que você desenha/ajusta fica em <strong>ciano</strong>; as linhas do CAR ficam em amarelo. <strong>Caminhar a divisa</strong>: ande pelo perímetro —
