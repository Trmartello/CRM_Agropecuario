    ...
    <div class="modal-content">
      ...
      <div class="modal-body d-flex flex-column p-2 gap-2">
        ...
        <div class="small text-muted">
          ...
          use +/− ou a roda do mouse para o zoom, arraste um ponto para ajustar, dê <strong>dois toques sobre a linha para inserir um ponto</strong> ali e refinar, e <strong>dois toques em um ponto para removê-lo</strong> (ou toque uma vez no ponto e no ✕). A divisa que você desenha/ajusta fica em <strong>ciano</strong>; as linhas do CAR ficam em amarelo. <strong>Caminhar a divisa</strong>: ande pelo perímetro —
