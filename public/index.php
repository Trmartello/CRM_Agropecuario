...
$router->registrar('clientes/renomear-exclusao', ClientesController::class, 'renomearExclusao');
...
$router->registrar('portal/fiscal-upload', \App\Controllers\PortalController::class, 'fiscalUpload');
